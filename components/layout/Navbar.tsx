        ...
        <nav className="hidden md:flex items-center gap-1">
          {navItems.map((item) => (
            <button
              ...
              className="relative group px-3.5 py-2 text-[11px] font-montserrat font-semibold tracking-[0.15em] uppercase text-stone-500 hover:text-stone-800 transition-colors duration-200"
            >
              {item.label}
